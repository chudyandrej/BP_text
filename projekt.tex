...
\projectinfo{
  ...
  author.name={Andrej},   %jmeno autora (pro citaci) / author name (for reference) 
  ...
  %Skolitel / supervisor
  supervisor=Drahanský Martin, %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
  ...
  supervisor.title.p=Doc. Ing., Dipl.-Ing.,   %titul pred jmenem (nepovinne) / title before the name (optional)
