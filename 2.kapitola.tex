...
Jednotlivé etapy spracovávania obrazu možno vyjadriť grafom, ktorý znázornuje postupnosť jednotlivých krokov v závislosti na množstve dát a veľkosti abstrakcie v jednotlivých krokoch. 
